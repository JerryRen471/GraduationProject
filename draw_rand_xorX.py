...
subset=['delta', 'J', 'lambda', 'train_set_type', 'loss', 'length', 'time_interval', 'evol_num', 'sample_num', 'entangle_dim']

print(data)
try:
    write_to_csv(data=data, csv_file_path='/data/home/scv7454/run/GraduationProject/Data/xorX_new.csv', subset=subset, dtypes=dtypes)
except Exception as e:
    print(e)
