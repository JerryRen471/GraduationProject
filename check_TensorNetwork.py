...
if __name__ == '__main__':
    ...
    mps = TensorTrain_pack(states, length=length, phydim=2, center=0, chi=10, device=device, dtype=dtype)
    ...
    # print('distance between mps and state', tc.dist(states2.squeeze(), mps2state.squeeze()))
