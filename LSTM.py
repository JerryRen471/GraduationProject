...
if __name__ == '__main__':
    ...
    file = open('D:\\Manual\\Code\\tests\\Graduation Project\\data.txt', mode='r')
    ...
    np.savetxt('D:\\Manual\\Code\\tests\\LSTMdata\\train_loss.txt', results['train_loss'])
    np.savetxt('D:\\Manual\\Code\\tests\\LSTMdata\\test_pre.txt', results['test_pred'])
    np.savetxt('D:\\Manual\\Code\\tests\\LSTMdata\\test_loss.txt', results['test_loss'])
