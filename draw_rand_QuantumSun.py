...
parser.add_argument('--csv_path', type=str, default="GraduationProject/Data/QuantumSun.csv")
...
subset=['train_set_type', 'loss', 'length', 'dot_size', 'alpha', 'time_interval', 'evol_num', 'sample_num']
write_to_csv(data=data, csv_file_path=args.csv_path, subset=subset)
